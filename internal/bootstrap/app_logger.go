...
func VreateAppLog(dir string, truncated bool, standAlone bool, levelLog zerolog.LevelWriter) {
	...
	core.AppLog = zerolog.New(zerolog.MultiLevelWriter(file, levelLog)).With().Timestamp().Caller().Logger()
