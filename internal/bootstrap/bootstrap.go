...
const (
	...
	ITEM_CATEGORY_SQL_SCHEMA string = "CREATE TABLE IF NOT EXISTS item_category (id SERIAL PRIMARY KEY,name VARCHAR(100) NOT NULL UNIQUE,scope VARCHAR(30) NOT NULL ,version VARCHAR(30) NOT NULL ,rechargeable BOOL NOT NULL ,description VARCHAR(100) NOT NULL)"
