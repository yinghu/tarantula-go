...
const file_mail_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"mail.proto\x12\bprotocol\x1a\vtopic.proto\x1a\n" +
	"task.proto\"c\n" +
	"\x04Mail\x12\x10\n" +
	"\x03opt\x18\x01 \x01(\aR\x03opt\x12%\n" +
	"\x05topic\x18\x02 \x01(\v2\x0f.protocol.TopicR\x05topic\x12\"\n" +
	"\x04task\x18\x03 \x01(\v2\x0e.protocol.TaskR\x04taskBL\n" +
...
var file_mail_proto_depIdxs = []int32{
	...
	2, // 1: protocol.Mail.task:type_name -> protocol.Task
