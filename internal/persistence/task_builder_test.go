...
func TestTaskBuilder(t *testing.T) {
	...
	tb.Job(&protocol.Meta{NodeId: "node1", Tag: "", Name: "register", Id: 1}).Add(&protocol.Transaction{Meta: &protocol.Meta{NodeId: "node1", Tag: "inventory", Name: "grant", TaskId: 1, Id: 10}, Object: kv}).Add(&protocol.Transaction{Meta: &protocol.Meta{NodeId: "node1", Tag: "asset", Name: "update", TaskId: 1, Id: 20}, Object: kv})
	task := tb.Build()
